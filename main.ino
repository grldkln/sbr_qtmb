...
void loop() 
{
    ...
    regData.readHreg(WiFi.localIP(), 0, regVal, REG_AMOUNT); //Tambah untuk baca register
    regData.Hreg(0, angleSample);
    regData.task();

    switch(regVal[DIR_REG])
    {
      case 0:
      stabilityControl.Start(angleSample, 0, targetAngle);
      break;
      ...
      case 1:
      stabilityControl.Start(angleSample, 0, (targetAngle + F_OFFSET));
      break;

      case 2:
      stabilityControl.Start(angleSample, 0, (targetAngle - R_OFFSET));
      break;
    }
}
